...
This class is a copy of the trainer from [textattack](https://textattack.readthedocs.io/en/latest/api/trainer.html) . Due to a bug in this class, we could not use their version, but we needed to resolve the bug first (there was a type issue between tuples and lists).
However, the main code remains the same.
